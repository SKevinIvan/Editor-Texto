...
public class Lexico_A {
    ...
    private ArrayList<Lexema_A> listaLexico;
     ...
     */
    public Lexico_A(String textoCodigo, String separadores, String pathTablaExcel) {
     ...
     */
    public Lexico_A(String textoCodigo, String separadores, int[][] matrizTransaccionGeneral, char[] vecAlfabeto) {
        this.textoCodigo = textoCodigo;
        this.separadores = separadores;
     ...
     */
    public ArrayList<Lexema_A> getListaLexico() {
        return listaLexico;
    }
     ...
     */
    public void setListaLexico(ArrayList<Lexema_A> listaLexico) {
     ...
     */
    public ArrayList<Lexema_A> analisisLexico() {
                    ...
                    if ((getListaLexico().get(i + 1).getNumToken() == 59) && (getListaLexico().get(i).getRenglon() == getListaLexico().get(i + 1).getRenglon())) {
                        if (i + 2 < getListaLexico().size()) {
                            if ((getListaLexico().get(i + 2).getNumToken() == 77)
                                ...
                                Lexema_A num2 = getListaLexico().remove(i + 2);
                                Lexema_A pun = getListaLexico().remove(i + 1);
    ...
    private void buscarTokensFijos(ArrayList<String> lstPalabras) {
        ...
        for (int i = 0; i < lstPalabras.size(); i++) {
            ...
            Lexema_A cadenaAnalizada = new Lexema_A();
    ...
    private Lexema_A buscaAutomata(String palabra, String lexema) {
