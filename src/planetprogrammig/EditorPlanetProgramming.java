...
public final class EditorPlanetProgramming extends javax.swing.JFrame {
    ...
    public EditorPlanetProgramming() {
        ...
        crearPestaniaEdicion(imageLenguaje);
...
//                javax.imageio.ImageIO.write( g, "jpg", file);
    ...
    private void jMenuItem10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem10ActionPerformed
        // TODO add your handling code here:
        crearPagEdicion("", imageARCHIVOSTEXTO, "");
    ...
    private void jTree1ValueChanged(javax.swing.event.TreeSelectionEvent evt) {//GEN-FIRST:event_jTree1ValueChanged
        ...
        Object rut[] = rutaArbol.getPath();
        String rutaFinal = "";
        for (int j = 0; j < rut.length; j++) {
            rutaFinal += "\\" + rut[j];
        }
        String url = rutaPaterna + rutaFinal;
        ImageIcon img = null;
        if (url.equals("\\Vacío")) {
        } else {
            try {
                ...
                if (arc.isFile()) {
                    ...
                    url = arc.getCanonicalPath(); //obtiene la ruta del archivo
                    String etiquetaNombre = arc.getName(); //obtiene el nombre del archivo/cancion                
    ...
    public void crearPestaniaCompilacion() {
        ...
        if (txtPanelCompilando == null) {
            ...
            txtPanelCompilando.setSelectionColor(new java.awt.Color(102, 153, 255));
    ...
    public void crearPestaniaSalida() {
        ...
        if (txtPanelSalida == null) {
            ...
            EmptyBorder eb = new EmptyBorder(new Insets(5, 15, 0, 0));
            txtPanelSalida.setBorder(eb);
            ...
            txtPanelSalida.setSelectionColor(new java.awt.Color(102, 153, 255));
        ...
        try {
            ...
            if (archivoExtraido != null) // si no se selecciono ningun archivo no hace nada
            {
                if (archivoExtraido.isFile()) {
                    ...
                    TextPaneTest.appendToPane(txtPanelSalida, "\nAbriendo achivo...", cVerde);
                    String etiExt[] = archivoExtraido.getName().split("\\.");
                    String extencion = "";
                    if (etiExt.length != 0) {
                        extencion = etiExt[etiExt.length - 1];
                    }
    ...
    private final ImageIcon imageCLASS = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/Class.png"));
    // private final ImageIcon PACKAGE = new ImageIcon(ClassLoader.getSystemResource("/Resources/Img/Package.png"));
    // private final ImageIcon PROYECT = new ImageIcon(ClassLoader.getSystemResource("/Resources/Img/Project.png"));
    private final ImageIcon imageCOMPILED_CLASS = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/Configuration.png"));
    // private final ImageIcon FOLDER_SOURCE = new ImageIcon(ClassLoader.getSystemResource("/Resources/Img/FolderCodes.png"));
    // private final ImageIcon FOLDER_BUILD = new ImageIcon(ClassLoader.getSystemResource("/Resources/Img/FolderBuild.png"));
    private final ImageIcon imageY = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/y.png"));
    private final ImageIcon imageWORD = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/word.png"));
    private final ImageIcon imageWEB = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/web.png"));
    private final ImageIcon imageVUEJS = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/vuejs.png"));
    ...
    private final ImageIcon imagePYSOURCE = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/pysource.png"));
    private final ImageIcon imagePOWERPOINT = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/powerpoint.png"));
    private final ImageIcon imagePL = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/pl.png"));
    private final ImageIcon imagePICTURE = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/picture.png"));
    private final ImageIcon imagePHP = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/php.png"));
    private final ImageIcon imagePAINT = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/paint.png"));
    private final ImageIcon imageP = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/p.png"));
    private final ImageIcon imageO = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/o.png"));
    // private final ImageIcon NUEVOFOLDER = new ImageIcon(ClassLoader.getSystemResource("/Resources/Img/nuevoFolder.png"));
    private final ImageIcon imageLOGOGITHUB = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/logoGiHub.png"));
    private final ImageIcon imageL = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/l.png"));
    private final ImageIcon imageJS = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/js.png"));
    private final ImageIcon imageJAVA = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/java.png"));
    private final ImageIcon imageJ = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/j.png"));
    private final ImageIcon imageHTML5 = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/html5.png"));
    private final ImageIcon imageH = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/h.png"));
    private final ImageIcon imageGITHUB = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/github.png"));
    private final ImageIcon imageGITHUB2 = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/github2.png"));
    private final ImageIcon imageFUENTE = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/fuente.png"));
    private final ImageIcon imageFORM = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/form.png"));
    // private final ImageIcon FOLDERWEB = new ImageIcon(ClassLoader.getSystemResource("/Resources/Img/folderWeb.png"));
    // private final ImageIcon FOLDERVIDEO = new ImageIcon(ClassLoader.getSystemResource("/Resources/Img/folderVideo.png"));
    // private final ImageIcon FOLDERVERDE = new ImageIcon(ClassLoader.getSystemResource("/Resources/Img/folderVerde.png"));
    //private final ImageIcon FOLDERSONIDO = new ImageIcon(ClassLoader.getSystemResource("/Resources/Img/folderSonido.png"));
    //private final ImageIcon FOLDERROJO = new ImageIcon(ClassLoader.getSystemResource("/Resources/Img/folderRojo.png"));
    //private final ImageIcon FOLDERRAYO = new ImageIcon(ClassLoader.getSystemResource("/Resources/Img/folderRayo.png"));
    // private final ImageIcon FOLDERPUBLIC = new ImageIcon(ClassLoader.getSystemResource("/Resources/Img/folderPublic.png"));
    // private final ImageIcon FOLDERMUSIC = new ImageIcon(ClassLoader.getSystemResource("/Resources/Img/folderMusic.png"));
    // private final ImageIcon FOLDERIMPRESORA = new ImageIcon(ClassLoader.getSystemResource("/Resources/Img/folderImpresora.png"));
    // private final ImageIcon FOLDERIMAGENES = new ImageIcon(ClassLoader.getSystemResource("/Resources/Img/folderImagenes.png"));
    // private final ImageIcon FOLDERGRIS = new ImageIcon(ClassLoader.getSystemResource("/Resources/Img/folderGris.png"));
    // private final ImageIcon FOLDERFAVORITO = new ImageIcon(ClassLoader.getSystemResource("/Resources/Img/folderFavorito.png"));
    // private final ImageIcon FOLDERDOCUMENTOS = new ImageIcon(ClassLoader.getSystemResource("/Resources/Img/folderDocumentos.png"));
    // private final ImageIcon FOLDERCONFIG = new ImageIcon(ClassLoader.getSystemResource("/Resources/Img/folderConfig.png"));
    // private final ImageIcon FOLDERBLOQUEADO = new ImageIcon(ClassLoader.getSystemResource("/Resources/Img/folderBloqueado.png"));
    // private final ImageIcon FOLDERAMARILLO = new ImageIcon(ClassLoader.getSystemResource("/Resources/Img/folderAmarillo.png"));
    // private final ImageIcon FOLDER = new ImageIcon(ClassLoader.getSystemResource("/Resources/Img/folder.png"));
    private final ImageIcon imageF = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/f.png"));
    private final ImageIcon imageEXCEL = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/excel.png"));
    // private final ImageIcon ESCRITORIO = new ImageIcon(ClassLoader.getSystemResource("/Resources/Img/escritorio.png"));
    private final ImageIcon imageELEFANT = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/elefant.png"));
    private final ImageIcon imageEDICION = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/edicion.png"));
    private final ImageIcon imageCSS3 = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/css3.png"));
    private final ImageIcon imageCSS = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/css.png"));
    private final ImageIcon imageCAFETAZA = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/cafeTaza.png"));
    private final ImageIcon imageC = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/c.png"));
    private final ImageIcon imageARCHIVOSTEXTO = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/archivotexto.png"));
    private final ImageIcon imageARCHIVOSVACIO = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/archivoVacio.png"));
    private final ImageIcon imageANGULAR = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/angular.png"));
    private final ImageIcon imageACROBOAD = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/acroread.png"));
    private final ImageIcon imageADOBE = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/acrobatadobe.png"));
    private final ImageIcon imageACCESS = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/access.png"));
    // private final ImageIcon FOLDERPAQUETES = new ImageIcon(ClassLoader.getSystemResource("/Resources/Img/FolderPaquetes.png"));
    private final ImageIcon imageIMAGEPNG = new ImageIcon(ClassLoader.getSystemResource("Resources/Img/Image.png"));
...
private final CustomJTree tree = new CustomJTree();
    ...
    private void crearPagEdicion(String s, ImageIcon extension, String nombre) {
        ...
        pestaniasEntradaSalidas.addTab(nombre, scrollPag);
        i++;
        ...
        if (creaa(root, fichero)) {
            ...
            if (fichero.isFile()) {
                if (fichero.getName().contains(".java")) {
                    ...
                    cat2 = new Node(Utils.TypeFile.PHP, fichero.getName());
                } else {
                    cat2 = new Node(Utils.TypeFile.TXT, fichero.getName());
                }
            ...
            for (File f : archivos) {
                ...
                if (f.isFile()) {
                    if (f.getName().contains(".java")) {
                        ...
                        Node cat2 = new Node(Utils.TypeFile.IMAGEPNG, f.getName());
                        DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(cat2);
                        //DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(f.getName());
                        modelo.insertNodeInto(hijo, root, contador);
                        contador++;
                    } else if (f.getName().contains(".class")) {
                        Node cat2 = new Node(Utils.TypeFile.JAVA, f.getName());
                        DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(cat2);
                        //DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(f.getName());
                        modelo.insertNodeInto(hijo, root, contador);
                        contador++;
                        ...
                        Node cat2 = new Node(Utils.TypeFile.PICTURE, f.getName());
                        DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(cat2);
                        //DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(f.getName());
                        modelo.insertNodeInto(hijo, root, contador);
                        contador++;
                    } else if (f.getName().contains(".docx")) {
                        Node cat2 = new Node(Utils.TypeFile.WORD, f.getName());
                        DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(cat2);
                        //DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(f.getName());
                        modelo.insertNodeInto(hijo, root, contador);
                        contador++;
                    } else if (f.getName().contains(".zip")) {
                        Node cat2 = new Node(Utils.TypeFile.FOLDERAMARILLO, f.getName());
                        DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(cat2);
                        //DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(f.getName());
                        modelo.insertNodeInto(hijo, root, contador);
                        contador++;
                    } else if (f.getName().contains(".rar")) {
                        Node cat2 = new Node(Utils.TypeFile.FOLDERROJO, f.getName());
                        DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(cat2);
                        //DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(f.getName());
                        modelo.insertNodeInto(hijo, root, contador);
                        contador++;
                    } else if (f.getName().contains(".sql")) {
                        Node cat2 = new Node(Utils.TypeFile.SQL, f.getName());
                        DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(cat2);
                        //DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(f.getName());
                        modelo.insertNodeInto(hijo, root, contador);
                        contador++;
                    } else if (f.getName().contains(".xlsx")) {
                        Node cat2 = new Node(Utils.TypeFile.EXCEL, f.getName());
                        DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(cat2);
                        //DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(f.getName());
                        modelo.insertNodeInto(hijo, root, contador);
                        contador++;
                        ...
                        modelo.insertNodeInto(hijo, root, contador);
                        contador++;
                    } else if (f.getName().contains(".css")) {
                        Node cat2 = new Node(Utils.TypeFile.CSS3, f.getName());
                        DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(cat2);
                        //DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(f.getName());
                        modelo.insertNodeInto(hijo, root, contador);
                        contador++;
                    } else if (f.getName().contains(".js")) {
                        Node cat2 = new Node(Utils.TypeFile.JS, f.getName());
                        DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(cat2);
                        //DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(f.getName());
                        modelo.insertNodeInto(hijo, root, contador);
                        contador++;
                    } else if (f.getName().contains(".py")) {
                        Node cat2 = new Node(Utils.TypeFile.PYTHON, f.getName());
                        DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(cat2);
                        //DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(f.getName());
                        modelo.insertNodeInto(hijo, root, contador);
                        contador++;
                    } else if (f.getName().contains(".pdf")) {
                        Node cat2 = new Node(Utils.TypeFile.ADOBE, f.getName());
                        DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(cat2);
                        //DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(f.getName());
                        modelo.insertNodeInto(hijo, root, contador);
                        contador++;
                        ...
                        Node cat2 = new Node(Utils.TypeFile.VIDEO, f.getName());
                        DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(cat2);
                        //DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(f.getName());
                        modelo.insertNodeInto(hijo, root, contador);
                        contador++;
                    } else if (f.getName().contains(".txt")) {
                        Node cat2 = new Node(Utils.TypeFile.ARCHIVOSTEXTO, f.getName());
                        DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(cat2);
                        //DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(f.getName());
                        modelo.insertNodeInto(hijo, root, contador);
                        contador++;
                    } else if (f.getName().contains(".rb")) {
                        Node cat2 = new Node(Utils.TypeFile.SKECTK, f.getName());
                        DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(cat2);
                        //DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(f.getName());
                        modelo.insertNodeInto(hijo, root, contador);
                        contador++;
                    } else if (f.getName().contains(".form")) {
                        Node cat2 = new Node(Utils.TypeFile.FORM, f.getName());
                        DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(cat2);
                        //DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(f.getName());
                        modelo.insertNodeInto(hijo, root, contador);
                        contador++;
                    } else if (f.getName().contains(".svg")) {
                        Node cat2 = new Node(Utils.TypeFile.WEB, f.getName());
                        DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(cat2);
                        //DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(f.getName());
                        modelo.insertNodeInto(hijo, root, contador);
                        contador++;
                    } else if (f.getName().contains(".git")) {
                        Node cat2 = new Node(Utils.TypeFile.LOGOGITHUB, f.getName());
                        DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(cat2);
                        //DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(f.getName());
                        modelo.insertNodeInto(hijo, root, contador);
                        contador++;
                    } else if (f.getName().contains(".php")) {
                        Node cat2 = new Node(Utils.TypeFile.PHP, f.getName());
                        DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(cat2);
                        //DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(f.getName());
                        modelo.insertNodeInto(hijo, root, contador);
                        contador++;
                    } else {
                        Node cat2 = new Node(Utils.TypeFile.TXT, f.getName());
                        DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(cat2);
                        //DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(f.getName());
                        modelo.insertNodeInto(hijo, root, contador);
                        contador++;
                    ...
                    switch (f.getName()) {
                        case "src": {
                            Node cat2 = new Node(Utils.TypeFile.FOLDERPAQUETES, f.getName());
                            DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(cat2);
                            //DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(f.getName());
                            modelo.insertNodeInto(hijo, root, contador);
                            contador++;
                        ...
                        case "Libraries": {
                            Node cat2 = new Node(Utils.TypeFile.FOLDERPUBLIC, f.getName());
                            DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(cat2);
                            //DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(f.getName());
                            modelo.insertNodeInto(hijo, root, contador);
                            contador++;
                        ...
                        case ".git": {
                            Node cat2 = new Node(Utils.TypeFile.GITHUB, f.getName());
                            DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(cat2);
                            //DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(f.getName());
                            modelo.insertNodeInto(hijo, root, contador);
                            contador++;
                        ...
                        case "Desktop": {
                            Node cat2 = new Node(Utils.TypeFile.ESCRITORIO, f.getName());
                            DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(cat2);
                            //DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(f.getName());
                            modelo.insertNodeInto(hijo, root, contador);
                            contador++;
                        ...
                        case "Imagenes": {
                            Node cat2 = new Node(Utils.TypeFile.FOLDERIMAGENES, f.getName());
                            DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(cat2);
                            //DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(f.getName());
                            modelo.insertNodeInto(hijo, root, contador);
                            contador++;
                        ...
                        case "Music": {
                            Node cat2 = new Node(Utils.TypeFile.FOLDERSONIDO, f.getName());
                            DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(cat2);
                            //DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(f.getName());
                            modelo.insertNodeInto(hijo, root, contador);
                            contador++;
                        ...
                        case "Movies": {
                            Node cat2 = new Node(Utils.TypeFile.FOLDERVIDEO, f.getName());
                            DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(cat2);
                            //DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(f.getName());
                            modelo.insertNodeInto(hijo, root, contador);
                            contador++;
                        ...
                        case "Documents": {
                            Node cat2 = new Node(Utils.TypeFile.FOLDERDOCUMENTOS, f.getName());
                            DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(cat2);
                            //DefaultMutableTreeNode hijo = new DefaultMutableTreeNode(f.getName());
                            modelo.insertNodeInto(hijo, root, contador);
                            contador++;
